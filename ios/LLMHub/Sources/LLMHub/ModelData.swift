...
public static let models: [AIModel] = [
    ...
    AIModel(
        ...
        description: "Google Gemma 4 E2B via LiteRT-LM — Google's native on-device runtime with GPU/Metal acceleration. Multimodal: supports text + vision. 128k context. (2.41 GB)",
    ...
    AIModel(
        ...
        description: "Google Gemma 4 E4B via LiteRT-LM — Google's native on-device runtime with GPU/Metal acceleration. Multimodal: supports text + vision. 128k context. (3.41 GB)",
