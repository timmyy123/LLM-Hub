...
public static let models: [AIModel] = [
    ...
    AIModel(
        ...
        description: "Ternary Bonsai 1.7B with Q2_0 ternary quantization. Smallest size for low-memory devices. (442MB)",
        url: "https://huggingface.co/prism-ml/Ternary-Bonsai-1.7B-gguf/resolve/main/Ternary-Bonsai-1.7B-Q2_0.gguf?download=true",
        category: .text,
        sizeBytes: 463290464,
        source: "Prism ML",
        supportsVision: false,
    ...
    AIModel(
        ...
        description: "Ternary Bonsai 4B with Q2_0 ternary quantization. Compact variant for mid-range devices. (1.00GB)",
        url: "https://huggingface.co/prism-ml/Ternary-Bonsai-4B-gguf/resolve/main/Ternary-Bonsai-4B-Q2_0.gguf?download=true",
        category: .text,
    ...
    AIModel(
        ...
        description: "Ternary Bonsai 8B in full float16 precision. Maximum quality, very large size. (15.25GB)",
        url: "https://huggingface.co/prism-ml/Ternary-Bonsai-8B-gguf/resolve/main/Ternary-Bonsai-8B-F16.gguf?download=true",
        category: .text,
    ...
    AIModel(
        ...
        description: "Ternary Bonsai 8B with Q2_0 ternary quantization. Smaller footprint for large models. (2.03GB)",
        url: "https://huggingface.co/prism-ml/Ternary-Bonsai-8B-gguf/resolve/main/Ternary-Bonsai-8B-Q2_0.gguf?download=true",
        category: .text,
