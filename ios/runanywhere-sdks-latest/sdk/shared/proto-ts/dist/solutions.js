...
exports.audioSourceToJSON = audioSourceToJSON;
exports.vectorStoreFromJSON = vectorStoreFromJSON;
...
function solutionTypeToJSON(object) {
    switch (object) {
...
function audioSourceFromJSON(object) {
    switch (object) {
        case 0:
...
function audioSourceToJSON(object) {
    switch (object) {
...
function vectorStoreFromJSON(object) {
    switch (object) {
        case 0:
...
function vectorStoreToJSON(object) {
    switch (object) {
...
exports.SolutionConfig = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.voiceAgent !== undefined) {
            exports.VoiceAgentConfig.encode(message.voiceAgent, writer.uint32(10).fork()).join();
        }
        ...
        if (message.timeSeries !== undefined) {
            exports.TimeSeriesConfig.encode(message.timeSeries, writer.uint32(42).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1: {
                    ...
                    message.voiceAgent = exports.VoiceAgentConfig.decode(reader, reader.uint32());
                    continue;
                }
                case 2: {
                    if (tag !== 18) {
                ...
                case 4: {
                    ...
                    message.agentLoop = exports.AgentLoopConfig.decode(reader, reader.uint32());
                    continue;
                }
                case 5: {
                    if (tag !== 42) {
                    ...
                    message.timeSeries = exports.TimeSeriesConfig.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            voiceAgent: isSet(object.voiceAgent)
                ? exports.VoiceAgentConfig.fromJSON(object.voiceAgent)
            ...
            agentLoop: isSet(object.agentLoop)
                ...
                : isSet(object.agent_loop)
                    ? exports.AgentLoopConfig.fromJSON(object.agent_loop)
                    : undefined,
            timeSeries: isSet(object.timeSeries)
                ? exports.TimeSeriesConfig.fromJSON(object.timeSeries)
                : isSet(object.time_series)
                    ? exports.TimeSeriesConfig.fromJSON(object.time_series)
                    : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.voiceAgent !== undefined) {
            obj.voiceAgent = exports.VoiceAgentConfig.toJSON(message.voiceAgent);
        }
        if (message.rag !== undefined) {
        ...
        if (message.timeSeries !== undefined) {
            obj.timeSeries = exports.TimeSeriesConfig.toJSON(message.timeSeries);
        }
        return obj;
    },
    create(base) {
        return exports.SolutionConfig.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSolutionConfig();
        ...
        message.timeSeries = (object.timeSeries !== undefined && object.timeSeries !== null)
            ? exports.TimeSeriesConfig.fromPartial(object.timeSeries)
            : undefined;
        return message;
    },
};
...
exports.SolutionHandle = {
    ...
    create(base) {
        return exports.SolutionHandle.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSolutionHandle();
...
exports.VoiceAgentConfig = {
    ...
    create(base) {
        return exports.VoiceAgentConfig.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseVoiceAgentConfig();
...
exports.RAGConfig = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4: {
                    ...
                    message.vectorStore = reader.int32();
                    continue;
                }
                case 5: {
                    if (tag !== 42) {
    ...
    create(base) {
        return exports.RAGConfig.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseRAGConfig();
...
exports.AgentLoopConfig = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.tools) {
            exports.ToolSpec.encode(v, writer.uint32(26).fork()).join();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3: {
                    ...
                    message.tools.push(exports.ToolSpec.decode(reader, reader.uint32()));
                    continue;
                }
                case 4: {
                    if (tag !== 32) {
        ...
        return {
            ...
            systemPrompt: isSet(object.systemPrompt)
                ...
                : isSet(object.system_prompt)
                    ? globalThis.String(object.system_prompt)
                    : "",
            tools: globalThis.Array.isArray(object?.tools) ? object.tools.map((e) => exports.ToolSpec.fromJSON(e)) : [],
    ...
    toJSON(message) {
        ...
        if (message.tools?.length) {
            obj.tools = message.tools.map((e) => exports.ToolSpec.toJSON(e));
        }
        if (message.maxIterations !== 0) {
    ...
    create(base) {
        return exports.AgentLoopConfig.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseAgentLoopConfig();
        message.llmModelId = object.llmModelId ?? "";
...
exports.ToolSpec = {
    ...
    create(base) {
        return exports.ToolSpec.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseToolSpec();
...
exports.TimeSeriesConfig = {
    ...
    create(base) {
        return exports.TimeSeriesConfig.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTimeSeriesConfig();
