...
// Source: runanywhere.v1.DownloadResumeResult in download_service.proto
@file:Suppress(
  "DEPRECATION",
...
public class DownloadResumeResult(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is DownloadResumeResult) return false
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<DownloadResumeResult> =
      ...
      override fun encode(writer: ProtoWriter, `value`: DownloadResumeResult) {
        if (value.accepted != false) {
      ...
      override fun decode(reader: ProtoReader): DownloadResumeResult {
      ...
      override fun redact(`value`: DownloadResumeResult): DownloadResumeResult = value.copy(
