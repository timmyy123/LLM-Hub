...
# ========================================================================================
# These rules are automatically applied to any app that depends on the RunAnywhere SDK.
# They ensure the SDK works correctly in release builds with R8/ProGuard enabled.
