...
| [linux-voice-assistant](linux-voice-assistant/) | Fully on-device voice assistant — VAD, STT, LLM, and TTS with zero cloud dependency | Linux (C++/ALSA) |
| [openclaw-hybrid-assistant](openclaw-hybrid-assistant/) | Hybrid voice assistant — on-device VAD, STT, and TTS with cloud LLM via OpenClaw WebSocket | Linux (C++/ALSA) |
