...
dependencies {
    ...
    implementation(files("libs/geniex-android-0.3.17.aar"))
...
// GenieX 0.3.17 bundles ~175 MB of QNN HTP runtime libs (libQnn*, libPlatformValidator,
...
dependencies { geniexAarConfig(files("libs/geniex-android-0.3.17.aar")) }
