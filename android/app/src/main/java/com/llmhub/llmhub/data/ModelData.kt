...
object ModelData {
    ...
    private const val PIPER_COMMIT = "e9ef9dd26adb6a40a9b47198817cd8e96d01e7cb"
    private const val PIPER_BASE = "https://huggingface.co/rhasspy/piper-voices/resolve/$PIPER_COMMIT"

    val ttsModels = listOf(
        LLMModel(
            name = "Piper TTS English (US)",
            description = "Piper neural TTS - English US, lessac voice. Fast on-device speech synthesis (60MB)",
            url = "$PIPER_BASE/en/en_US/lessac/medium/model.onnx",
            category = "tts",
            sizeBytes = 63206179L,
            ...
            contextWindowSize = 0,
            modelFormat = "onnx",
            additionalFiles = listOf("$PIPER_BASE/en/en_US/lessac/medium/model.onnx.json")
        ),
        LLMModel(
            name = "Piper TTS German",
            description = "Piper neural TTS - German, thorsten voice. Fast on-device speech synthesis (60MB)",
            url = "$PIPER_BASE/de/de_DE/thorsten/medium/model.onnx",
            category = "tts",
            sizeBytes = 63206113L,
            source = "rhasspy/piper-voices (HuggingFace)",
            supportsVision = false,
            ...
            contextWindowSize = 0,
            modelFormat = "onnx",
            additionalFiles = listOf("$PIPER_BASE/de/de_DE/thorsten/medium/model.onnx.json")
        ),
        LLMModel(
            name = "Piper TTS French",
            description = "Piper neural TTS - French, siwis voice. Fast on-device speech synthesis (60MB)",
            url = "$PIPER_BASE/fr/fr_FR/siwis/medium/model.onnx",
            category = "tts",
            sizeBytes = 63206169L,
            source = "rhasspy/piper-voices (HuggingFace)",
            supportsVision = false,
            ...
            contextWindowSize = 0,
            modelFormat = "onnx",
            additionalFiles = listOf("$PIPER_BASE/fr/fr_FR/siwis/medium/model.onnx.json")
        ),
        LLMModel(
            name = "Piper TTS Spanish",
            description = "Piper neural TTS - Spanish, davefx voice. Fast on-device speech synthesis (60MB)",
            url = "$PIPER_BASE/es/es_ES/davefx/medium/model.onnx",
            category = "tts",
            sizeBytes = 63206111L,
            source = "rhasspy/piper-voices (HuggingFace)",
            supportsVision = false,
            ...
            contextWindowSize = 0,
            modelFormat = "onnx",
            additionalFiles = listOf("$PIPER_BASE/es/es_ES/davefx/medium/model.onnx.json")
        ),
        LLMModel(
            name = "Piper TTS Portuguese (BR)",
            description = "Piper neural TTS - Brazilian Portuguese, faber voice. Fast on-device speech synthesis (60MB)",
            url = "$PIPER_BASE/pt/pt_BR/faber/medium/model.onnx",
            category = "tts",
            sizeBytes = 63206149L,
            source = "rhasspy/piper-voices (HuggingFace)",
            supportsVision = false,
            ...
            contextWindowSize = 0,
            modelFormat = "onnx",
            additionalFiles = listOf("$PIPER_BASE/pt/pt_BR/faber/medium/model.onnx.json")
        ),
        LLMModel(
            name = "Piper TTS Russian",
            description = "Piper neural TTS - Russian, denis voice. Fast on-device speech synthesis (60MB)",
            url = "$PIPER_BASE/ru/ru_RU/denis/medium/model.onnx",
            category = "tts",
            sizeBytes = 63206117L,
            source = "rhasspy/piper-voices (HuggingFace)",
            supportsVision = false,
            ...
            contextWindowSize = 0,
            modelFormat = "onnx",
            additionalFiles = listOf("$PIPER_BASE/ru/ru_RU/denis/medium/model.onnx.json")
        ),
        LLMModel(
            name = "Piper TTS Arabic",
            description = "Piper neural TTS - Arabic (Jordan), kareem voice. Fast on-device speech synthesis (60MB)",
            url = "$PIPER_BASE/ar/ar_JO/kareem/medium/model.onnx",
            category = "tts",
            sizeBytes = 63206318L,
            source = "rhasspy/piper-voices (HuggingFace)",
            supportsVision = false,
            ...
            contextWindowSize = 0,
            modelFormat = "onnx",
            additionalFiles = listOf("$PIPER_BASE/ar/ar_JO/kareem/medium/model.onnx.json")
        ),
        LLMModel(
            name = "Kokoro (No eSpeak)",
            description = "Kokoro GGUF TTS model without eSpeak dependency (354MB)",
            url = "https://huggingface.co/mmwillet2/Kokoro_GGUF/resolve/e9e81d8e813948353195c9db77ef065476335c8d/Kokoro_no_espeak.gguf",
            category = "tts",
            sizeBytes = 371002976L,
            source = "mmwillet2 (HuggingFace)",
            supportsVision = false,
            supportsAudio = true,
            supportsGpu = true,
        ...
        LLMModel(
            name = "Kokoro (No eSpeak F16)",
            description = "Float16 quantized Kokoro GGUF TTS model without eSpeak dependency (212MB)",
            url = "https://huggingface.co/mmwillet2/Kokoro_GGUF/resolve/e9e81d8e813948353195c9db77ef065476335c8d/Kokoro_no_espeak_F16.gguf",
            category = "tts",
            sizeBytes = 222062368L,
            source = "mmwillet2 (HuggingFace)",
            supportsVision = false,
            supportsAudio = true,
            supportsGpu = true,
        ...
        LLMModel(
            name = "Kokoro (No eSpeak Q4)",
            description = "Q4 quantized Kokoro GGUF TTS model without eSpeak dependency (189MB)",
            url = "https://huggingface.co/mmwillet2/Kokoro_GGUF/resolve/e9e81d8e813948353195c9db77ef065476335c8d/Kokoro_no_espeak_Q4.gguf",
            category = "tts",
            sizeBytes = 198096736L,
            source = "mmwillet2 (HuggingFace)",
            supportsVision = false,
            supportsAudio = true,
            supportsGpu = true,
        ...
        LLMModel(
            name = "Kokoro (No eSpeak Q5)",
            description = "Q5 quantized Kokoro GGUF TTS model without eSpeak dependency (191MB)",
            url = "https://huggingface.co/mmwillet2/Kokoro_GGUF/resolve/e9e81d8e813948353195c9db77ef065476335c8d/Kokoro_no_espeak_Q5.gguf",
            category = "tts",
            sizeBytes = 200180704L,
            source = "mmwillet2 (HuggingFace)",
            supportsVision = false,
            supportsAudio = true,
            supportsGpu = true,
        ...
        LLMModel(
            name = "Kokoro (No eSpeak Q8)",
            description = "Q8 quantized Kokoro GGUF TTS model without eSpeak dependency (197MB)",
            url = "https://huggingface.co/mmwillet2/Kokoro_GGUF/resolve/e9e81d8e813948353195c9db77ef065476335c8d/Kokoro_no_espeak_Q8.gguf",
            category = "tts",
            sizeBytes = 206432608L,
            source = "mmwillet2 (HuggingFace)",
            supportsVision = false,
            supportsAudio = true,
            supportsGpu = true,
