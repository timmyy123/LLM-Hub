...
object ModelData {
    ...
    val models: List<LLMModel> by lazy {
        val list = baseModels.toMutableList()
        val isSdxlSupported = DeviceInfo.getChipsetSuffix() in setOf("8gen3", "8gen4", "8gen5")
        if (isSdxlSupported) {
            list.addAll(sdxlModels)
        }
        list
    }
