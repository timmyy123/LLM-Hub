...
const OPEN_DESIGN_GITHUB_REPO_API = 'https://api.github.com/repos/timmyy123/LLM-Hub';
const OPEN_DESIGN_GITHUB_RELEASE_LATEST_API = 'https://api.github.com/repos/timmyy123/LLM-Hub/releases/latest';
