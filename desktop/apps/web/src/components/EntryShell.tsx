        ...
        <main className="entry-main entry-main--scroll" ref={entryMainScrollRef}>
          <div className="entry-main__topbar">
            ...
            <div className="entry-main__topbar-chips entry-main__topbar-chips--icon-only">
              ...
              <button
                type="button"
                className="entry-workspace-chip"
                onClick={() => setDownloadModalOpen(true)}
                title="Download Models"
                data-testid="entry-download-models"
              >
                <Icon name="download" size={14} className="entry-workspace-chip__icon" />
                <span className="entry-workspace-chip__label">Download Models</span>
              </button>
...
function OnboardingView({
  ...
  if (false && step === 0 && connectExpanded === null) {
