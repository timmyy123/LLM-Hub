...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to LLM Hub Studio Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to LLM Hub Studio Cloud & retry',
  'chat.amrError.authMessage': 'Your LLM Hub Studio Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your LLM Hub Studio Cloud balance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with LLM Hub Studio Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the LLM Hub Studio Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The LLM Hub Studio Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the LLM Hub Studio Cloud agent — steadier and better value.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update LLM Hub Studio to the latest version, which ships a compatible runtime.",
  'modelDownloader.title': 'Local Model Downloader',
  'modelDownloader.subtitle': 'Download & manage Ollama models on your machine',
  'modelDownloader.pullAnyModel': 'Pull Any Model',
  'modelDownloader.pullPlaceholder': 'Enter any Ollama model tag, e.g. llama3:8b, mistral:latest…',
  'modelDownloader.pull': 'Pull',
  'modelDownloader.downloading': 'Downloading',
  'modelDownloader.cancel': 'Cancel',
  'modelDownloader.gemma4Section': 'Gemma 4',
  'modelDownloader.installedSection': 'Installed Models',
  'modelDownloader.installedBadge': 'Installed ✓',
  'modelDownloader.download': 'Download',
  'modelDownloader.delete': 'Delete',
  'modelDownloader.deleteSuccess': '✓ Deleted',
  'modelDownloader.noModels': 'No models installed yet on http://localhost:11434',
  'modelDownloader.ollamaOffline': 'Ollama not responding on http://localhost:11434',
  'modelDownloader.successPrefix': '✓ Downloaded',
  'modelDownloader.cancelledPrefix': 'Cancelled —',
  ...
  'settings.welcomeTitle': 'Welcome to LLM Hub Studio',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. LLM Hub Studio will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. LLM Hub Studio reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to LLM Hub Studio',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to LLM Hub Studio',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to LLM Hub Studio Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the LLM Hub Studio daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to LLM Hub Studio.',
  ...
  'settings.amrAccountStatus': 'LLM Hub Studio Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose LLM Hub Studio as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'Zero data collection policy',
  'settings.privacyGuaranteeTitle': 'Privacy & Data Guarantee',
  'settings.privacyGuaranteeSubtitle': 'Complete local data sovereignty',
  'settings.privacyGuaranteeStatement': 'We never collect or have any interest in user data.',
  'settings.privacyGuaranteeBody': 'All code, prompts, chat messages, and model weights remain strictly on your local machine and offline.',
  'settings.privacyConsentKicker': 'Help us improve LLM Hub Studio',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how LLM Hub Studio performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time LLM Hub Studio starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but LLM Hub Studio could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your LLM Hub Studio projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure LLM Hub Studio is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in LLM Hub Studio, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'LLM Hub Studio must be running for MCP tool calls to succeed. If you started your coding agent before opening LLM Hub Studio, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Join the LLM Hub Studio Discord',
  'entry.discordAriaWithOnline': 'Join the LLM Hub Studio Discord - {online}',
  ...
  'entry.followLinkedinLabel': 'Follow LLM Hub Studio on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow LLM Hub Studio on Xiaohongshu',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable LLM Hub Studio plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit LLM Hub Studio Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local LLM Hub Studio project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. LLM Hub Studio Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use LLM Hub Studio workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with LLM Hub Studio and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to LLM Hub Studio',
  'pluginCard.contributeTitle': 'Contribute plugin to LLM Hub Studio with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use LLM Hub Studio from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure LLM Hub Studio is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use LLM Hub Studio everywhere',
  'useEverywhere.modalTitle': 'Use LLM Hub Studio everywhere',
  'useEverywhere.modalSubtitle': 'Drop LLM Hub Studio into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'LLM Hub Studio works wherever your agent works',
  'useEverywhere.section.overview.intro': 'LLM Hub Studio is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires LLM Hub Studio as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without LLM Hub Studio at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive LLM Hub Studio from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose LLM Hub Studio as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'LLM Hub Studio ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover LLM Hub Studio tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the LLM Hub Studio app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without LLM Hub Studio running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). LLM Hub Studio extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside LLM Hub Studio and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + LLM Hub Studio extras)',
  ...
  'entry.githubStarAria': 'Star LLM Hub Studio on GitHub',
  ...
  'newproj.locationDefault': 'LLM Hub Studio projects',
  ...
  'avatar.amrConsole': 'LLM Hub Studio Cloud',
  ...
  'socialShare.openDesignSection': 'Share LLM Hub Studio',
  'socialShare.openDesignTitle': 'LLM Hub Studio on GitHub',
  'socialShare.openDesignText': 'LLM Hub Studio is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with LLM Hub Studio: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with LLM Hub Studio: {title}\n{url}\nLLM Hub Studio repo: {repo}',
  ...
  'brandEnrichment.body': "LLM Hub Studio will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask LLM Hub Studio to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want LLM Hub Studio to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure LLM Hub Studio is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying LLM Hub Studio? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to LLM Hub Studio on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow LLM Hub Studio on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow LLM Hub Studio on Xiaohongshu for tips and inspiration.',
  ...
  'assistant.shareToOpenDesign': 'Share to LLM Hub Studio',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with LLM Hub Studio — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with LLM Hub Studio — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple LLM Hub Studio project folders. New projects are saved as one folder inside the selected base.',
  ...
  'updater.availableBody': 'LLM Hub Studio {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'LLM Hub Studio is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'LLM Hub Studio could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. LLM Hub Studio is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit LLM Hub Studio',
  'updater.quitFailedBody': 'The installer is open, but LLM Hub Studio could not quit. Quit LLM Hub Studio before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. LLM Hub Studio will close and open the installer.',
  'updater.readyVersion': 'LLM Hub Studio {version} is ready. LLM Hub Studio will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. LLM Hub Studio will close and open the installer.',
  'updater.reinstallReadyVersion': 'LLM Hub Studio {version} requires a full reinstall. LLM Hub Studio will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach LLM Hub Studio your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions LLM Hub Studio follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach LLM Hub Studio your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'LLM Hub Studio turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
