...
export const fa: Dict = {
  ...
  'chat.amrCard.switchBody': 'به سرویس رسمی مدل LLM Hub Studio Cloud سوئیچ کنید — بدون نیاز به تنظیم کلید API. پس از ورود، اعطای دسترسی و شارژ، این اجرا به‌طور خودکار دوباره انجام می‌شود.',
  ...
  'chat.amrCard.switchCta': 'سوئیچ به LLM Hub Studio Cloud و تلاش مجدد',
  'chat.amrError.authMessage': 'حساب LLM Hub Studio Cloud شما هنوز مجاز نشده است. آن را مجاز کنید تا این اجرا به‌طور خودکار دوباره انجام شود.',
  'chat.amrError.balanceMessage': 'موجودی LLM Hub Studio Cloud شما تمام شده است. برای ادامه این اجرا شارژ کنید.',
  'chat.amrError.authorizeCta': 'اعطای دسترسی و تلاش مجدد',
  'chat.amrError.rechargeCta': 'شارژ LLM Hub Studio Cloud',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'آنچه LLM Hub Studio Cloud به شما می‌دهد',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'شما از ایجنت LLM Hub Studio Cloud استفاده می‌کنید — وارد شوید تا این وظیفه بلافاصله شروع شود.',
  ...
  'chat.runError.signInMessage.amr': 'عامل LLM Hub Studio Cloud هنوز وارد نشده است — برای استفاده وارد شوید.',
  'chat.runError.signInMessage.other': '{agent} وارد نشده است. وضعیت ورود را به‌صورت محلی بررسی کنید. عامل LLM Hub Studio Cloud را توصیه می‌کنیم — پایدارتر و مقرون‌به‌صرفه‌تر.',
  ...
  'chat.runError.cpuUnsupportedMessage': "محیط اجرای این عامل به مجموعه دستورالعمل پردازنده (AVX2) نیاز دارد که این دستگاه فاقد آن است، بنابراین نمی‌تواند اجرا شود. LLM Hub Studio را به آخرین نسخه که محیط اجرای سازگار دارد به‌روزرسانی کنید.",
    'modelDownloader.title': 'دانلودر مدل محلی',
  'modelDownloader.subtitle': 'دانلود و مدیریت مدل‌های Ollama روی دستگاه شما',
  'modelDownloader.pullAnyModel': 'دانلود هر مدل',
  'modelDownloader.pullPlaceholder': 'هر برچسب مدل Ollama را وارد کنید، مثال: llama3:8b, mistral:latest…',
  'modelDownloader.pull': 'دانلود',
  'modelDownloader.downloading': 'در حال دانلود',
  'modelDownloader.cancel': 'لغو',
  'modelDownloader.gemma4Section': 'Gemma 4',
  'modelDownloader.installedSection': 'مدل‌های نصب‌شده',
  'modelDownloader.installedBadge': 'نصب شده ✓',
  'modelDownloader.download': 'دانلود',
  'modelDownloader.delete': 'حذف',
  'modelDownloader.deleteSuccess': '✓ حذف شد',
  'modelDownloader.noModels': 'هنوز مدلی روی http://localhost:11434 نصب نشده',
  'modelDownloader.ollamaOffline': 'Ollama روی http://localhost:11434 پاسخ نمی‌دهد',
  'modelDownloader.successPrefix': '✓ دانلود شد',
  'modelDownloader.cancelledPrefix': 'لغو شد —',
  'modelDownloader.errorPrefix': 'خطا:',
  'common.cancel': 'لغو',
  ...
  'settings.welcomeTitle': 'به LLM Hub Studio خوش آمدید',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'شروع با یک شرح',
  'settings.onboardingCreateBody': 'سایت، اپلیکیشن، ارائه، تصویر یا ویدیویی را که می‌خواهید توصیف کنید. LLM Hub Studio یک پروژه می‌سازد و کار را قابل ویرایش نگه می‌دارد.',
  ...
  'settings.onboardingMemoryCalloutBody': 'این پاسخ‌ها نمایهٔ حافظهٔ شما را شکل می‌دهند. LLM Hub Studio در هر کار از آن استفاده می‌کند و همزمان با کار شما به یادگیری ادامه می‌دهد.',
  ...
  'settings.onboardingAmrCloudAuthorizeAction': 'مجوزدهی LLM Hub Studio Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'مراحل بعدی با هوش مصنوعی اجرا می‌شوند — برای ادامه وارد LLM Hub Studio Cloud شوید.',
  ...
  'settings.agentInstall.stepAuth': 'قبل از بازگشت به LLM Hub Studio، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.amrAccountStatus': 'وضعیت حساب LLM Hub Studio Cloud',
  ...
  'settings.amrLoginErrorCompact': 'ورود به LLM Hub Studio Cloud ناموفق بود.',
  ...
  'settings.mcpServerHint': 'LLM Hub Studio را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'settings.privacyHint': 'سیاست عدم جمع‌آوری داده‌ها',
  'settings.privacyGuaranteeTitle': 'تضمین حریم خصوصی و داده‌ها',
  'settings.privacyGuaranteeSubtitle': 'حاکمیت کامل بر داده‌های محلی',
  'settings.privacyGuaranteeStatement': 'ما هرگز اطلاعات کاربران را جمع‌آوری نمی‌کنیم و هیچ علاقه‌ای به آن نداریم.',
  'settings.privacyGuaranteeBody': 'تمام کدها، پرامپت‌ها، پیام‌های چت و وزن‌های مدل به طور کامل در دستگاه محلی شما و آفلاین باقی می‌مانند.',
  'settings.privacyConsentKicker': 'به ما در بهبود LLM Hub Studio کمک کنید',
  'settings.privacyConsentLead': 'اشتراک‌گذاری داده‌های استفاده به ما کمک می‌کند عملکرد LLM Hub Studio را در جریان‌های کاری واقعی بهتر بفهمیم تا بخش‌هایی را که بیشترین اثر را بر تجربه شما دارند بهبود دهیم.',
  ...
  'settings.updateQuitFailed': 'نصب‌کننده باز شد، اما LLM Hub Studio نتوانست خودکار خارج شود.',
  ...
  'settings.mcpHint': 'به Agentهای کدنویسی (Cursor، Claude Code، VS Code…) اجازه دهید پروژه‌های LLM Hub Studio شما را مستقیماً بخوانند.',
  'settings.mcpDaemonError': 'امکان دسترسی به daemon محلی برای تعیین مسیرهای نصب وجود نداشت ({error}). مطمئن شوید که LLM Hub Studio در حال اجراست، سپس این پنل را دوباره باز کنید.',
  ...
  'settings.mcpCapabilityDefault': 'به‌صورت پیش‌فرض از پروژه و فایلی که در LLM Hub Studio باز کرده‌اید استفاده می‌کند، بنابراین می‌توانید بگویید «این را در اپ من بساز» بدون اینکه دوباره مشخص کنید کدام طراحی.',
  'settings.mcpRunningNote': 'برای موفقیت فراخوانی‌های ابزار MCP، LLM Hub Studio باید در حال اجرا باشد. اگر Agent کدنویسی خود را پیش از باز کردن LLM Hub Studio راه‌اندازی کرده‌اید، Agent را راه‌اندازی مجدد کنید تا بتواند به daemon زنده دسترسی پیدا کند.',
  ...
  'entry.followLinkedinLabel': 'دنبال کردن LLM Hub Studio در LinkedIn',
  'entry.followXiaohongshuLabel': 'دنبال کردن LLM Hub Studio در Xiaohongshu',
  ...
  'homeHero.chip.createPluginHint': 'یک افزونه قابل استفاده مجدد LLM Hub Studio بسازید و آن را به افزونه‌های من اضافه کنید.',
  ...
  'handoff.amrWebsite': 'باز کردن وب‌سایت LLM Hub Studio Cloud',
  ...
  'handoff.promptIntro': 'ادامه از این پوشه محلی پروژه LLM Hub Studio:',
  ...
  'pluginsHome.subtitle': 'گردش‌کارهای آماده LLM Hub Studio که همراه این runtime ارائه شده‌اند. یکی را برای بارگذاری یک پرامپت شروع انتخاب کنید، یا برای موارد بیشتر در رجیستری بگردید.',
  ...
  'pluginsHome.emptyCatalog': 'کاتالوگ خالی است. پلاگین‌های همراه با LLM Hub Studio ارائه می‌شوند و باید به‌صورت خودکار اینجا نمایش داده شوند — اگر این مشکل ادامه داشت، daemon را مجدداً راه‌اندازی کنید.',
  ...
  'pluginCard.contributeAria': 'مشارکت {title} در LLM Hub Studio',
  'pluginCard.contributeTitle': 'مشارکت افزونه در LLM Hub Studio با یک PR',
  ...
  'integrations.lede': 'سیستم‌های خارجی را متصل کنید، ابزارهای MCP را به حلقه Agent خود بیاورید و از LLM Hub Studio در سایر IDEها، اسکریپت‌ها و خودکارسازی‌ها استفاده کنید.',
  ...
  'mcpClient.daemonError': 'دسترسی به daemon محلی ممکن نشد. مطمئن شوید LLM Hub Studio در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'mcpClient.saveFailed': 'ذخیره ناموفق بود. بررسی کنید که daemon در حال اجرا باشد و دوباره تلاش کنید.',
  'useEverywhere.modalAria': 'استفاده از LLM Hub Studio در همه‌جا',
  'useEverywhere.modalTitle': 'استفاده از LLM Hub Studio در همه‌جا',
  'useEverywhere.modalSubtitle': 'LLM Hub Studio را در هر IDE، Agent یا اسکریپتی بگنجانید — CLI، HTTP، MCP و Skills. از «Copy guide for an agent» استفاده کنید و آن را در Claude Code، Codex، Cursor، openclaw یا hermes جای‌گذاری کنید تا همه‌چیز راه‌اندازی شود.',
  ...
  'useEverywhere.section.overview.heading': 'LLM Hub Studio هر جا که Agent شما کار کند، کار می‌کند',
  'useEverywhere.section.overview.intro': 'LLM Hub Studio چیزی فراتر از یک پنجره است — یک daemon محلیِ دارای دسترسی ویژه (`od`) به‌علاوه یک رجیستری از Skills + Design-Systems + Atoms است. به‌محض اینکه روی دستگاه شما در حال اجرا باشد، هر code agent (Claude Code، Codex، Cursor، OpenCode/openclaw، Hermes، یا اسکریپت خودتان) می‌تواند تولیدها را هدایت کند، پروژه‌ها را بررسی کند و از طریق چهار سطح قابل‌تعویض، آثار طراحی تولید کند.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` برای اسکریپت‌های headless، CI و اتوماسیون shell.',
  'useEverywhere.section.overview.bullet2': 'سرور MCP — LLM Hub Studio را به‌عنوان یک سرور Model Context Protocol سیم‌کشی می‌کند تا هر Agent سازگار با MCP بتواند skillها را فهرست کند، سناریوها را اجرا کند و آثار را بخواند.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — بسته‌های آمادهٔ `SKILL.md` (سازگار با Claude) که هر Agent موجود در PATH شما می‌تواند بدون نیاز به LLM Hub Studio اصلاً فراخوانی‌شان کند.',
  ...
  'useEverywhere.section.cli.heading': 'کنترل LLM Hub Studio از هر shell',
  ...
  'useEverywhere.section.mcp.heading': 'در معرض قرار دادن LLM Hub Studio به‌عنوان یک سرور MCP برای هر Agent کدنویسی',
  'useEverywhere.section.mcp.intro': 'LLM Hub Studio با یک سرور Model Context Protocol (`od mcp`) ارائه می‌شود که به هر کلاینت سازگار با MCP — Cursor، Claude Code، Antigravity، VS Code Copilot Chat، openclaw، hermes — اجازه می‌دهد ابزارهای LLM Hub Studio را کشف کند (فهرست‌کردن skillها، رندر پیش‌نمایش‌ها، تولید رسانه، اجرای پلاگین‌ها) بدون نیاز به اجرای دستی در shell. این daemon برای هر کلاینت اصلی یک قطعهٔ نصب آمادهٔ جای‌گذاری را از طریق `GET /api/mcp/install-info` منتشر می‌کند.',
  ...
  'useEverywhere.section.mcp.footer': 'در اپلیکیشن LLM Hub Studio، به Settings ← Integrations بروید تا یک دستور نصب مخصوص کلاینت (Cursor، Claude Code، Antigravity، VS Code) را کپی کنید، به‌جای ویرایش دستی JSON.',
  ...
  'useEverywhere.section.skills.heading': 'Skillهای آمادهٔ استفاده برای هر Agent — حتی بدون اجرای LLM Hub Studio',
  'useEverywhere.section.skills.intro': 'یک Skill دایرکتوری‌ای است با یک `SKILL.md` سازگار با Claude (فرانت‌متر YAML + بدنه). LLM Hub Studio این فرمت را با namespace به نام `od:` گسترش می‌دهد (`mode`، `preview`، `design_system`، `inputs`، …) تا همان اثر هم درون LLM Hub Studio و هم توسط یک Agent معمولی مانند Claude Code، Codex، openclaw یا hermes قابل‌استفاده باشد. کشف از یک زنجیرهٔ اولویت پیروی می‌کند تا پروژه‌ها بتوانند skillهای خود را بازنویسی کنند.',
  ...
  'useEverywhere.section.skills.snippet1': 'حداقل SKILL.md (front matter سازگار با Claude + افزوده‌های LLM Hub Studio)',
  ...
  'entry.githubStarAria': 'به LLM Hub Studio در GitHub ستاره بدهید',
  ...
  'newproj.locationDefault': 'پروژه‌های LLM Hub Studio',
  ...
  'avatar.amrConsole': 'حساب LLM Hub Studio Cloud',
  ...
  'socialShare.openDesignSection': 'اشتراک‌گذاری LLM Hub Studio',
  'socialShare.openDesignTitle': 'LLM Hub Studio در GitHub',
  'socialShare.openDesignText': 'LLM Hub Studio یک فضای کاری متن‌باز برای ساخت، ویرایش، استقرار و تحویل آرتیفکت‌های طراحی است.',
  ...
  'socialShare.projectText': 'ساخته‌شده با LLM Hub Studio: {title}. آرتیفکت مستقرشده را ببینید و به مخزن ستاره بدهید: {repo}',
  'socialShare.projectCopyText': 'ساخته‌شده با LLM Hub Studio: {title}\n{url}\nمخزن LLM Hub Studio: {repo}',
  ...
  'brandEnrichment.body': "LLM Hub Studio یک استخراج عمیق تر را در پس زمینه اجرا می کند، skills مناسب design system را خودکار اعمال می کند و همین سیستم را درجا به روز می کند. این کار ممکن است 10 تا 20 دقیقه طول بکشد؛ می توانید به کارتان ادامه دهید.",
  ...
  'chat.activeFilePlaceholder': 'از LLM Hub Studio بخواهید {file} را تغییر دهد...',
  ...
  'chat.mode.design.solves': 'وقتی می خواهید LLM Hub Studio فایل بسازد، workspace را به روز کند یا brief را به خروجی های چندرسانه ای قابل تحویل تبدیل کند استفاده کنید.',
  ...
  'preview.shareTextDefault': 'قالب LLM Hub Studio: {title}',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید LLM Hub Studio در حال اجراست و دوباره تلاش کنید.',
  ...
  'designFiles.usefulInfoTip7': 'از LLM Hub Studio راضی هستید؟ در GitHub به ما ستاره بدهید.',
  ...
  'designFiles.usefulInfoTip18': 'برای آموزش‌ها و دموها، LLM Hub Studio را در YouTube دنبال کنید.',
  'designFiles.usefulInfoTip19': 'برای اخبار محصول، LLM Hub Studio را در LinkedIn دنبال کنید.',
  'designFiles.usefulInfoTip20': 'برای نکته‌ها و الهام، LLM Hub Studio را در Xiaohongshu دنبال کنید.',
  ...
  'assistant.shareToOpenDesign': 'اشتراک‌گذاری در LLM Hub Studio',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه LLM Hub Studio — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه LLM Hub Studio ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'settings.projectLocationsDescription': 'پایه‌های کاری اضافه کنید که می‌توانند چند پوشهٔ پروژهٔ LLM Hub Studio را در خود داشته باشند. پروژه‌های جدید به‌صورت یک پوشه داخل پایهٔ انتخاب‌شده ذخیره می‌شوند.',
  ...
  'settings.customInstructionsHint': 'دستورالعمل‌های ثابتی که LLM Hub Studio باید در هر گفت‌وگو دنبال کند. حقایق، ترجیحات و زمینهٔ پروژه را به‌عنوان حافظه ذخیره کنید.',
  ...
  'settings.memoryStarterProjectDesc': 'LLM Hub Studio v0.5 — ویرایشگر طراحی مبتنی بر گفتگو',
  ...
  'updater.activeRunsTitle': 'LLM Hub Studio هنوز در حال کار است',
  'updater.activeRunsBody': '{count} کار فعال هنوز در حال اجراست. راه‌اندازی مجدد اکنون آن‌ها را متوقف می‌کند.',
  'updater.activeRunsUnknownBody': 'LLM Hub Studio نتوانست بررسی کند که آیا کاری در حال اجراست. راه‌اندازی مجدد ممکن است کار فعال را متوقف کند.',
  'updater.availableBody': 'LLM Hub Studio {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. LLM Hub Studio در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.quitButton': 'بستن LLM Hub Studio',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما LLM Hub Studio بسته نشد. پیش از جایگزینی برنامه، LLM Hub Studio را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. LLM Hub Studio بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'LLM Hub Studio {version} آماده است. LLM Hub Studio بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.reinstallLearnMore': 'اطلاعات بیشتر',
  'updater.reinstallReadyGeneric': 'این به‌روزرسانی به نصب مجدد کامل نیاز دارد. LLM Hub Studio بسته می‌شود و نصب‌کننده باز خواهد شد.',
  'updater.reinstallReadyVersion': 'LLM Hub Studio {version} به نصب مجدد کامل نیاز دارد. LLM Hub Studio بسته می‌شود و نصب‌کننده باز خواهد شد.',
  ...
  'dsManager.createBody': 'برند، محصول، کد، دارایی‌ها و مراجع طراحی خود را به LLM Hub Studio بیاموزید.',
  ...
  'settings.customInstructionsDesc': 'دستورالعمل‌های ثابتی که LLM Hub Studio در هر گفت‌وگو از آن‌ها پیروی می‌کند. این‌ها حافظه ذخیره‌شده نیستند؛ برای واقعیت‌ها، ترجیحات و بافت پروژه از حافظه استفاده کنید.',
  ...
  'onboarding.buildBody': 'LLM Hub Studio برند شما را به یک سیستم طراحی قابل‌استفاده‌ی مجدد تبدیل می‌کند و هر چیزی را که می‌سازید هماهنگ و وفادار به برند نگه می‌دارد.',
