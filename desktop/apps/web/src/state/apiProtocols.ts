...
export const SUGGESTED_MODELS_BY_PROTOCOL: Record<ApiProtocol, readonly string[]> = {
  ...
  // Ollama models are fetched live from the local Ollama service
  // (localhost:11434/api/tags). Do NOT add static suggestions here —
  // the dropdown shows only what the user has actually downloaded.
  ollama: [],
};
